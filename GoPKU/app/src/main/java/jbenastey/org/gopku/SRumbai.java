...
public class SRumbai extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try{
            ...
            if (pilihan.equals("Call Center")){
                ...
                sr = new Intent(Intent.ACTION_DIAL, Uri.parse(tel));
            }
            else if (pilihan.equals("Info Maps")){
//                String geo = "geo:0.482323,101.419719"; //isi dengan posisi sr
//                sr = new Intent(Intent.ACTION_VIEW, Uri.parse(geo));
//                //set app default untuk buka intent ini apabila ada beberapa aplikasi yang dapat membuka
//                sr.setPackage("com.google.android.apps.maps");
                sr = new Intent(this,SRumbaiLocation.class);
            }
            else if (pilihan.equals("Driving Direction")){
                String geo = "google.navigation:q=0.572677,101.430097"; //isi dengan posisi sr
                sr = new Intent(Intent.ACTION_VIEW, Uri.parse(geo));
            }
            else if (pilihan.equals("Website")){
                String web = "http://www.sr.com";
                sr = new Intent(Intent.ACTION_VIEW, Uri.parse(web));
            }
            else if (pilihan.equals("Search Info")){
                sr = new Intent(Intent.ACTION_WEB_SEARCH);
                sr.putExtra(SearchManager.QUERY,("Stadion Kaharuddin Nasution"));
            }
                ...
                sr = new Intent(Intent.ACTION_VIEW,dekatsaya);
                sr.setPackage("com.google.android.apps.maps");
            }
