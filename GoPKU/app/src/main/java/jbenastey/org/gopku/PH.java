...
public class PH extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try{
            ...
            if (pilihan.equals("Call Center")){
                ...
                ph = new Intent(Intent.ACTION_DIAL, Uri.parse(tel));
            }
            else if (pilihan.equals("Info Maps")){
//                String geo = "geo:0.482323,101.419719"; //isi dengan posisi pitza hats
//                ph = new Intent(Intent.ACTION_VIEW, Uri.parse(geo));
//                //set app default untuk buka intent ini apabila ada beberapa aplikasi yang dapat membuka
//                ph.setPackage("com.google.android.apps.maps");
                ph = new Intent(this,PHLocation.class);
            }
            else if (pilihan.equals("Driving Direction")){
                String geo = "google.navigation:q=0.498836,101.417830"; //isi dengan posisi pitza hats
                ph = new Intent(Intent.ACTION_VIEW, Uri.parse(geo));
            }
            else if (pilihan.equals("Website")){
                String web = "https://www.pizzahut.co.id";
                ph = new Intent(Intent.ACTION_VIEW, Uri.parse(web));
            }
            else if (pilihan.equals("Search Info")){
                ph = new Intent(Intent.ACTION_WEB_SEARCH);
                ph.putExtra(SearchManager.QUERY,("Pizza Hut"));
            }
                ...
                ph = new Intent(Intent.ACTION_VIEW,dekatsaya);
                ph.setPackage("com.google.android.apps.maps");
            }
